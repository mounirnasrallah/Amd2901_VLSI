 ...
 # close this UpdateSession now. So the chip will see the core correctly.
  ...
  try:
   ...
   # TODO: Placing pads
    ...
    northPads = ['p_i0','p_i1','p_i2','p_i3','p_i4','p_vddeck0','p_vddeck1','p_i5','p_i6','p_i7','p_i8']
    westPads  = ['p_cin','p_r0','p_q0','p_a0','p_a1','p_a2','p_a3','p_b0','p_b1','p_b2','p_b3']
